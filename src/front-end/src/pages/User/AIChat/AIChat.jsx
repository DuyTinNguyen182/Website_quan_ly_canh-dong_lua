          ...
          <div className="w-full max-w-5xl mx-auto space-y-6">
                      ...
                      <div className="prose prose-sm md:prose-base prose-emerald max-w-none">
                        <ReactMarkdown
                          components={{
                            ...
                            ul: ({ children }) => (
                              <ul className="list-disc mb-3 ml-5 space-y-1">
                                {children}
                              </ul>
                            ),
                            ol: ({ children }) => (
                              <ol className="list-decimal mb-3 ml-5 space-y-1">
                                {children}
                              </ol>
                            ),
                            li: ({ children }) => (
            ...
            {isTyping && (
              <div className="flex w-full animate-slide-up justify-start">
                <div className="flex max-w-[98%] gap-3 items-end flex-row">
                  <div className="hidden md:flex w-9 h-9 md:w-10 md:h-10 rounded-full flex-shrink-0 items-center justify-center bg-emerald-100/50 text-emerald-600 ring-4 ring-white shadow-sm shadow-emerald-100">
                    <Bot size={20} />
                  </div>
                  <div className="px-6 py-4 rounded-[24px] rounded-bl-[8px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white border border-slate-100/60 flex items-center gap-1.5 h-[52px]">
                    <div
